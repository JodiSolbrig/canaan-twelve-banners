...
The engine is the authority on what the game *is*; when the two disagree and the
engine is right, the design package gets corrected rather than a row added here.
The rows below are real interpretive choices, not documentation drift.
